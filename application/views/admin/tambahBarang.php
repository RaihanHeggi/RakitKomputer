  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="ml-4 mr-3">
        ...
        <form action="<?= site_url('tambah_data_barang') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="tipebarang" id="tipebarang" placeholder="Masukkan Tipe Barang" required>
            </div>
            <div class="form-group">
                <label for="merkbarang" style="font-weight:bold">MERK BARANG</label>
                <input type="text" class="form-control" name="merkbarang" id="merkbarang" placeholder="Masukkan Merk Barang" required>
            </div>
            <div class="form-group">
                <label for="hargabarang" style="font-weight:bold">HARGA BARANG</label>
                <input type="text" class="form-control" name="hargabarang" id="hargabarang" placeholder="Masukkan Harga Barang" required>
            </div>
            <div class="form-group">
                <label for="stokbarang" style="font-weight:bold">STOK BARANG</label>
                <input type="text" class="form-control" name="stokbarang" id="stokbarang" placeholder="Masukkan Stok Barang" required>
            </div>
