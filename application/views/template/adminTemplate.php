...
<head>
	...
	<!-- Bootstrap core CSS-->
	<link href="<?php echo $this->config->item('base_url'); ?>/assets/vendor/bootstrap/css/bootstrap.min.css"
		rel="stylesheet">
	<!-- Custom fonts for this template-->
	<link href="<?php echo $this->config->item('base_url'); ?>/assets/vendor/font-awesome/css/font-awesome.min.css"
		rel="stylesheet" type="text/css">
	<!-- Page level plugin CSS-->
	<link href="<?php echo $this->config->item('base_url'); ?>/assets/vendor/datatables/dataTables.bootstrap4.css"
		rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
		<a class="navbar-brand" href="<?= site_url('index_admin') ?>">Rakit Komputer</a>
		...
		<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
			...
			<a class="nav-link" href="<?= site_url('index_admin') ?>">
				<i class="fa fa-fw fa-dashboard"></i>
				<span class="nav-link-text">Dashboard</span>
			</a>
			</li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Barang">
			<a class="nav-link" href="<?= site_url('data_barang') ?>">
				<i class="fa fa-fw fa-area-chart"></i>
				<span class="nav-link-text">Barang</span>
			</a>
			</li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
			<a class="nav-link" href="<?= site_url('data_pelanggan') ?>">
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
				  <a class="nav-link" href="<?= site_url('laporan_keuangan') ?>">
					  <i class="fa fa-fw fa-table"></i>
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
				<a class="nav-link" href="<?= site_url('tambah_data_admin') ?>">
					<i class="fa fa-fw fa-keyboard-o"></i>
						<span class="nav-link-text">Tambah Data Staff</span>
				</a>
			</li>
		</ul>
	...
	<script src="<?php echo $this->config->item('base_url'); ?>/assets/vendor/jquery-easing/jquery.easing.min.js">
	</script>
